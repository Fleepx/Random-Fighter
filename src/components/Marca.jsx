 ...
 *
 * En la barra el nombre se retira solo cuando se arma la isla: eso lo
 * resuelve Navbar.css colapsando el ancho, no un prop, para que la
 * transicion acompane al resto de la barra.
 */
