...
const SpecularButton = ({
  ...
  className = '',
  type = 'button',
  // Adaptacion local: con href renderiza un enlace en vez de un boton.
  // Los botones de descarga apuntan a la tienda, y un <button> no navega,
  // no abre en pestana nueva y no se puede copiar con clic derecho.
  href,
  target,
  rel
}) => {
  ...
  useEffect(() => {
    ...
    // Sin esto el bucle de render corre para siempre aunque el sistema
    // haya pedido menos animacion.
